            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <div class="dataTables_length" id="example1_length">
                        <label>
                            <a class="btn btn-primary btn-shadow text-white mr-2" href="createrViewsCate">Add News <i
                        ...
                        foreach ($data as $value) {
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td class="text-center"><a
                                            ...
                                            href="getNewsCateById/<?= $value->id ?>">Edit <i class="fas fa-edit"></i> </a> <a
...
<script>
    ...
    function DoDelete(id) {
        $.ajax({
            type: "DELETE",
            url: "/news/admin/deleteNewsCate/" + id,
            dataType: "html",
