                            ...
                            <form action="SubmitRegister" method="post">
                                <div class="modal-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input id="exampleName" name="username" placeholder="Name here..."
                                                       type="text"
                                                       class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="position-relative form-group">
                                                <input name="date_of_birth" id="examplePassword"
                                    ...
                                    <p class="text-center" style="color:#d33333">
                                    <?php
                                    if (isset($_GET['error'])) {
                                        if ($_GET['error'] == 0) {
                                    ...
                                    <h6 class="mb-0">Already have an account?
                                        <a href="Login" class="text-primary">Sign in</a> | <a
                                                href="ForgotPassword" class="text-primary">Recover Password</a>
                                    </h6>
                                </div>
