				...
				<div class="row small-gutters">
					<div class="col-lg-8 top-post-left">
						<div class="feature-image-thumb relative">
							...
							<img class="img-fluid" src="/news/public/views/img/top-post1.jpg" alt="">
						</div>
					...
					<div class="col-lg-4 top-post-right">
						<div class="single-top-post">
							<div class="feature-image-thumb relative">
								<div class="overlay overlay-bg"></div>
								<img class="img-fluid" src="/news/public/views/img/top-post2.jpg" alt="">
							</div>
							<div class="top-post-details">
								<ul class="tags">
									<li><a href="#">Food Habit</a></li>
						...
						<div class="single-top-post mt-10">
							<div class="feature-image-thumb relative">
								<div class="overlay overlay-bg"></div>
								<img class="img-fluid" src="/news/public/views/img/top-post3.jpg" alt="">
							</div>
							<div class="top-post-details">
								<ul class="tags">
									<li><a href="#">Food Habit</a></li>
							...
							<div class="row mt-20 medium-gutters">
								...
								<div class="col-lg-6 single-popular-post">
									<div class="feature-img-wrap relative">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="/news/public/views/img/f3.jpg" alt="">
										</div>
										<ul class="tags">
											<li><a href="#">Travel</a></li>
										</ul>
							...
							<div class="relavent-story-list-wrap">
								<div class="single-relavent-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="/news/public/views/img/r1.jpg" alt="">
										</div>
										<ul class="tags">
								...
								<div class="single-relavent-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="/news/public/views/img/r2.jpg" alt="">
										</div>
										<ul class="tags">
								...
								<div class="single-relavent-post row align-items-center">
									<div class="col-lg-5 post-left">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="/news/public/views/img/r3.jpg" alt="">
										</div>
										<ul class="tags">
											<li><a href="#">Travel</a></li>
										</ul>
						...
						<div class="sidebars-area">
							<div class="single-sidebar-widget editors-pick-widget">
								...
								<div class="editors-pick-post">
									<div class="feature-img-wrap relative">
										<div class="feature-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid" src="/news/public/views/img/e1.jpg" alt="">
										</div>
										<ul class="tags">
											<li><a href="#">Travel</a></li>
										</ul>
									...
									<div class="details">
										<a href="image-post.html">
											<h4 class="mt-20">A Discount Toner Cartridge Is Better Than
												Ever.</h4>
										</a>
										<ul class="meta">
											<li><a href="#"><span class="lnr lnr-user"></span>Mark wiens</a></li>
									...
									<div class="post-lists">
										...
										<div class="single-post d-flex flex-row">
											<div class="thumb">
												<img src="/news/public/views/img/e3.jpg" alt="">
											</div>
											<div class="detail">
												<a href="image-post.html"><h6>Compatible Inkjet Cartr world
														famous</h6></a>
												<ul class="meta">
													<li><a href="#"><span class="lnr lnr-calendar-full"></span>03
															April, 2018</a></li>
										...
										<div class="single-post d-flex flex-row">
											<div class="thumb">
												<img src="/news/public/views/img/e4.jpg" alt="">
											</div>
											<div class="detail">
							...
							<div class="single-sidebar-widget most-popular-widget">
								...
								<div class="single-list flex-row d-flex">
									<div class="thumb">
										<img src="/news/public/views/img/m1.jpg" alt="">
									</div>
									<div class="details">
										<a href="image-post.html">
								...
								<div class="single-list flex-row d-flex">
									<div class="thumb">
										<img src="/news/public/views/img/m3.jpg" alt="">
									</div>
									<div class="details">
										<a href="image-post.html">
